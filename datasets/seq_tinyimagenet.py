...
class TinyImagenet(Dataset):
    ...
    def __init__(self, root: str, train: bool=True, transform: transforms=None,
        ...
        # self.root = root
        self.root = '/apdcephfs/private_coltonwu/Continual-Learning/Meta-CL-methods-innerVR/utils/data/TINYIMG'
        self.train = train
        ...
        for num in range(20):
            self.data.append(np.load(os.path.join(
                self.root, 'processed/x_%s_%02d.npy' %
...
class SequentialTinyImagenet(ContinualDataset):
    ...
    #                     * SequentialTinyImagenet.N_TASKS)
    def get_backbone():
        return resnet18_maml(SequentialTinyImagenet.N_CLASSES_PER_TASK
                        * SequentialTinyImagenet.N_TASKS)
    # def get_backbone():
    #     return PC_CNN(3*32*32,SequentialTinyImagenet.N_CLASSES_PER_TASK
    #                     * SequentialTinyImagenet.N_TASKS)
    # def get_backbone():
    #     return resnet18(SequentialTinyImagenet.N_CLASSES_PER_TASK
    #                     * SequentialTinyImagenet.N_TASKS)
